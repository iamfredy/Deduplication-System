...
import static sockets.User1.User;
import static sockets.User1.dos;
import static sockets.User1.soc;
...
public class User2 extends javax.swing.JFrame {
    ...
    public User2() throws IOException {
        initComponents();
        User="Me";
    ...
    private void initComponents() {
        ...
        txtChatroom.setBackground(new java.awt.Color(204, 255, 204));
        txtChatroom.setColumns(20);
        txtChatroom.setForeground(new java.awt.Color(0, 255, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(txtMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
...
//        String sofar=txtChatroom.getText()+"\n"+User+":"+txtMsg.getText();        
//        txtChatroom.setText(sofar);
        try{
            String sofar=txtChatroom.getText()+"\n"+User+":"+txtMsg.getText();            
